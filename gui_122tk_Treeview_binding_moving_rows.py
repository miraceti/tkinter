...
def select_record():
    ...
    #selection de la ligne (nombre)
    selected =  my_tree.focus()
    
    #selection de la ligne (nvaleur  ou texte)
    values = my_tree.item(selected, 'values' )
    
    #check de la valeur selectionné
...
def update_record():
    ...
    # save new data
    my_tree.item(selected, text="" , values=(name_box.get(), id_box.get(), topics_box.get()))
...
#creation de la fonction binding click
def clicker(e):
    select_record()
