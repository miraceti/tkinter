...
edit_menu.add_command(label="Couper    (Ctrl+x)", command=lambda: cut_text(False))
edit_menu.add_command(label="Copier     (Ctrl+c)", command=lambda: copy_text(False))
edit_menu.add_command(label="Coller      (Ctrl+v)", command=lambda: paste_text(False))
edit_menu.add_command(label="Annuler", command=lambda: cut_text(1))
edit_menu.add_command(label="Refaire", command=lambda: cut_text(1))
