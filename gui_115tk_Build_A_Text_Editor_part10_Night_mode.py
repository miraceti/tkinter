...
def night_on():
    main_color="#000000" #noir
    second_color = "#373737" #gris foncé
    text_color = "green"
    #menu et status barre
...
def night_off():
    main_color="SystemButtonFace" #noir
    second_color = "SystemButtonFace" #gris foncé
    text_color = "black"
    #menu et status barre
    root.config(bg=main_color)
    status_bar.config(bg=main_color, fg=text_color)
