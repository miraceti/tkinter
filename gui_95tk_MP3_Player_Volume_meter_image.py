...
def play():
    ...
    current_volume = pygame.mixer.music.get_volume()
    #*100 pour plus facile a utiliser
...
#liste box playlist
song_box = Listbox(master_frame, bg="black", fg="yellow", width=60, selectbackground="red", selectforeground="black")
...
volume_meter.grid(row=1, column=1, pady=10)
