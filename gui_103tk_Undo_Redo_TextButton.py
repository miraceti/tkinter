...
def open_text():
    ...
    title = text_file
    title = title.replace('D:/eric/python/gui/','')
...
my_text = Text(my_frame, width=40, height=10,font=("helvetica",20), selectbackground="yellow", selectforeground="black", yscrollcommand=text_scroll.set, undo=True)
my_text.pack(pady=5)
